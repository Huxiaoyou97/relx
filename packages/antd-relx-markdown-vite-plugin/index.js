...
function markdownToVue(source, options) {
    ...
    return `
<template><div class="rx-site-doc">${templateString}</div></template>
...
function RelxMarkdownVitePlugin(options) {
    return {
        name: 'relx-markdown-vite-plugin',
        enforce: 'pre',
        transform(source, id) {
            if (!/\.md$/.test(id)) {
                return
...
module.exports = RelxMarkdownVitePlugin
