...
export const RELX_CONFIG = resolve(CWD, 'relx.config.mjs')
...
export const SITE_DIR = resolve(CWD, '.relx/site')
export const SITE_PC_DIR = resolve(CWD, '.relx/site/pc')
export const SITE_PC_ROUTES = resolve(CWD, '.relx/pc.routes.ts')
export const SITE_MOBILE_ROUTES = resolve(CWD, '.relx/mobile.routes.ts')
export const SITE_CONFIG = resolve(CWD, '.relx/site.config.json')
